...
const Computer = forwardRef(
  (
    { containedEntities, dispatchInputAction, closeInspector, ...props },
    ref
  ) => {
    ...
    const handleOnSubmit = useCallback(
      event => {
        ...
        dispatchInputAction(entity.state, "answer", answer).then(() =>
          setAnswersSubmitted(answersSubmitted => answersSubmitted + 1)
        )
      },
    ...
    useEffect(() => {
      if (answersSubmitted > 0 && isAnswered) {
        closeInspector()
      }
    }, [answersSubmitted])
