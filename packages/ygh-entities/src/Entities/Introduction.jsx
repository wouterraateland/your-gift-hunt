...
const Introduction = forwardRef(({ dispatchInputAction, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <Message isVisible={letterOpened}>
        {message.split("\n").map((part, key) => (
          <P key={key}>{part}</P>
        ))}
      </Message>
...
Introduction.templateName = "Introduction"
Introduction.defaultProps = Entity.defaultProps
