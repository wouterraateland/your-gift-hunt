...
const Stone = styled(ObjectPart).attrs(props => ({
  style: {
    left: `${props.l}em`,
    top: `${props.t}em`,
  ...
  &::before {
    ...
    box-shadow: inset
      ${props =>
        Math.cos(((270 - props.a - props.parentAngle) * Math.PI) / 180) *
        props.s}em
      ${props =>
        Math.sin(((270 - props.a - props.parentAngle) * Math.PI) / 180) *
        props.s}em
      ${props => props.s}em #0004;
