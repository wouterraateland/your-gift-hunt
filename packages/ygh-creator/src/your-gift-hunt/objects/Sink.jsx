...
const Worktop = styled(ObjectPart)`
  left: 0;
  top: 0;
  right: 0;
  bottom: 0;
...
const SinkPart = styled(ObjectPart)`
  left: 20%;
  top: 1em;
  bottom: 0.5em;
...
const Faucet = styled(ObjectPart)`
  left: 0;
  bottom: 0.25em;
  right: 0;
  margin: auto;
...
const Sink = forwardRef(({ state }, refs) => {
